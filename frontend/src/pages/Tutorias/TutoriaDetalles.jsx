  ...
  useEffect(() => {
    if (id) {
      ...
      if (puedeVerPendientes()) {
        ...
        cargarEstudiantesCompleto(); // ← Agrega esta línea
      }
      // 🔥 NUEVO: Cargar contadores y evaluaciones
    ...
    <div className="lg:col-span-3 space-y-6">
      ...
      <div className="space-y-4">
        ...
        <CollapsibleSection 
          ...
          count={contadorActividades} // Puedes agregar el count real aquí
          icon={
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <CollapsibleSection 
          ...
          count={evaluaciones.length} // Usa el estado de evaluaciones
          icon={
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
...
>
  {puedeVerInscritos() ? (
    <div>
      ...
      {/* Nueva tabla completa de estudiantes */}
      <TablaEstudiantes 
        tutoriaId={id}
      ...
      <div className="sticky top-8 space-y-6">
        ...
        <div className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 shadow-sm">
          ...
          <div className="space-y-3">
            ...
            {isEstudiante && (
              <button className="w-full px-4 py-3 text-sm bg-gradient-to-r from-amber-500 to-amber-600 text-white hover:from-amber-600 hover:to-amber-700 rounded-xl transition-all flex items-center space-x-3 shadow-sm">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
